...
func (e *AppError) RootError() error {
	// syntax: type assertions (means: check property `RootErr` of `e` is type AppError)
	// Luc nay minh se truy cap vao RootErr, kiem tra rang no co phai 1 con tro cua *AppError hay khong, neu co ok
...
func (e *AppError) Error() string {
	//Bat ky 1 struct hay method nao co implement Error() string thi se dc coi la error
	//Dong thai nay de AppError duoc tinh la 1 error
